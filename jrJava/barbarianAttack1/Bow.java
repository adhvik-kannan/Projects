...
public class Bow implements MouseListener, MouseMotionListener {
	...
	private static Point[] bowGrip_template = new Point[] { new Point(-2, -15), new Point(-2, 15), new Point(3, 15),
			new Point(3, -15), new Point(-2, -15) };

	private static Point[] bow_0_template = new Point[] { new Point(-1, -15), new Point(0, -55), new Point(15, -45),
			new Point(16, -74), new Point(17, -74), new Point(15, -45), new Point(1, -53), new Point(2, -15),
			new Point(-2, -15), new Point(-1, 15), new Point(0, 55), new Point(15, 45), new Point(16, 74),
			new Point(17, 74), new Point(15, 45), new Point(1, 55), new Point(2, 15), new Point(-2, 15) };

	private static Point[] bow_100_template = new Point[] { new Point(-1, -15), new Point(10, -54), new Point(45, -35),
			new Point(56, -54), new Point(57, -54), new Point(45, -34), new Point(4, -49), new Point(2, -15),
			new Point(-2, -15), new Point(-1, 15), new Point(10, 54), new Point(45, 35), new Point(56, 54),
			new Point(57, 54), new Point(45, 34), new Point(4, 49), new Point(2, 15), new Point(-2, 15),
			new Point(0, 0) };
