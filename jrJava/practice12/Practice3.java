...
public class Practice3 {
	...
	public static void main(String[] args) {
		...
		moveBall(board, timer, Color.GREEN, 80, -50, 300, 500, -100);
		moveBall(board, timer, Color.GREEN, 80, 500, -100, 300, 300);
	}

	public static void moveBall(DrawingBoard board, Timer timer, Color color, int radius, int x1, int y1, int x2,
			int y2) {
