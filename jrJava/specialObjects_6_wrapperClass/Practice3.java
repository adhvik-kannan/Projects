...
public class Practice3 {
	...
	public static void main(String[] args) {
		...
		// Auto un-boxing (deboxing): Whenever and wherever it needs a primitive type data,
		// but what it sees is a wrapper class objects, it will automatically extract out
