...
public class MyGUI implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource().equals(item1A)) smallPanel.setBounds(340, 20, 100, 200);
		else if(e.getSource().equals(item1B)) smallPanel.setBounds(340, 60, 100, 200);
		else if(e.getSource().equals(item1C)) smallPanel.setBounds(320, 40, 100, 200);
		else if(e.getSource().equals(item1D)) smallPanel.setBounds(360, 40, 100, 200);
		else if(e.getSource().equals(item1E)) smallPanel.setBounds(340, 40, 100, 200);
