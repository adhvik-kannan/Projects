...
public class AlienManager {
	...
	public static void create() {
		...
		if(rand<1/7.0) alien = new CloakAlien(x, 0, image, imageAlt, vx, vy);
		else if(rand<2/7.0) alien = new NastyAlien(x, 0, image, imageAlt, vx, vy);
		else if(rand<3/7.0) alien = new MultiShootAlien(x, 0, image, imageAlt, vx, vy);
		else if(rand<4/7.0) alien = new CloningAlien(x, 0, image, imageAlt, vx, vy);
		else if(rand<5/7.0) alien = new EvilAlien(x, 0, image, imageAlt, vx, vy);
		else if(rand<6/7.0) alien = new UnfriendlyAlien(x, 0, image, imageAlt, vx, vy);
