...
public class Test {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * list.insertAtEnd("aaa"); list.insertAtEnd("bbb"); list.insertAtEnd("ccc");
		 * list.insertAtEnd("ddd");
		 * 
		 * Iterator iter = new MyIterator(list); while(iter.hasNext()) { Integer each =
		 * (Integer) iter.next(); System.out.println(each); }
		 */
