...
public class MyArrayList {
	...
	public void add(Object ref) {
		...
		/*
		 * if(lastElementIndex==elements.length-1) { Object[] elements2 = new
		 * Object[elements.length*2]; for(int i=0; i<=lastElementIndex; i++)
		 * elements2[i] = elements[i]; elements = elements2; }
		 * elements[lastElementIndex+1] = ref; lastElementIndex++;
		 */
	}
