...
public class Basic4 {
	...
	public static void main(String[] args) throws IOException {
		...
		BufferedImage bImage = ImageIO.read(new File("jrJava/imagesForManipulation/transformer.png"));
		...
		ImageIO.write(empty, "png", new File("jrJava/imagesForManipulation/transformer2.png"));
